...
The program reads a single integer and prints one of the following based on the rules: Accepted, Suspect, or Rejected.
...
<img width="1640" height="558" alt="image" src="https://github.com/user-attachments/assets/9fd44151-dc92-4104-96d4-d52f15ccfd64" />
